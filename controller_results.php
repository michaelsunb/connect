...
class _resultsController implements Controller
{
   ...
   private function indexAction()
   {
      ...
      {
         /** 
          * Check if $posts year request is equal to
      ...
      {
         /** 
          * Check if $posts grape_variety request is equal to
          * the select so we can remember the selected box.
          */
      ...
      {
         /** 
          * Check if $posts region request is equal to
          * the select so we can remember the selected box.
          */
      ...
      /** Put $posts winesearch request back into the view. */
      ...
      /** Put $posts winerysearch request back into the view. */
      ...
      {
         $html_session .= '<p><a href="session_viewed.html" target="_blank">View Previous Session</a></p>';
      }
